! function(e) {
...
}([function(e, t, n) { n(1), n(2), n(3), n(4), n(9), n(11), n(12), e.exports = n(33) }, function(e, t, n) {
    var i, o;
    ! function(t, n) {
        ...
        function H(e, t, n) {
            ...
            if (ie.isEmptyObject(d)) "inline" === ("none" === c ? S(e.nodeName) : c) && (h.display = c);
                ...
                g ? "hidden" in g && (f = g.hidden) : g = ke.access(e, "fxshow", {}), a && (g.hidden = !f), f ? ie(e).show() : p.done(function() { ie(e).hide() }), p.done(function() {
                    var t;
                    ke.remove(e, "fxshow");
        ...
        ie.fn = ie.prototype = {
            ...
            now: Date.now,
            support: ee
        }), ie.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(e, t) { J["[object " + t + "]"] = t.toLowerCase() });
        var le = function(e) {
            function t(e, t, n, i) {
                ...
                if (!i && O) {
                    ...
                    if (k.qsa && (!L || !L.test(e))) {
                        ...
                        } catch (m) {} finally { p || t.removeAttribute("id") }
                    }
                }
            ...
            var w, k, x, _, S, C, T, P, j, E, A, D, I, N, O, L, H, M, B, $ = "sizzle" + 1 * new Date,
                ...
                _e = function() { D() };
            try { Q.apply(Y = Z.call(F.childNodes), F.childNodes), Y[F.childNodes.length].nodeType } catch (Se) {
                Q = {
            ...
            k = t.support = {}, S = t.isXML = function(e) {
                ...
                })), (k.matchesSelector = ve.test(M = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && o(function(e) { k.disconnectedMatch = M.call(e, "div"), M.call(e, "[s!='']:x"), H.push("!=", re) }), L = L.length && new RegExp(L.join("|")), H = H.length && new RegExp(H.join("|")), t = ve.test(N.compareDocumentPosition), B = t || ve.test(N.contains) ? function(e, t) {
        ...
        ie.extend({
            ...
            removeData: function(e, t) { xe.remove(e, t) },
            _data: function(e, t, n) {
                return ke.access(e, t, n)
            },
            _removeData: function(e, t) { ke.remove(e, t) }
        }), ie.fn.extend({
            data: function(e, t) {
                var n, i, o, a = this[0],
                    r = a && a.attributes;
            ...
            removeData: function(e) {
                return this.each(function() { xe.remove(this, e) })
            }
        }), ie.extend({
            ...
            dequeue: function(e, t) {
                ...
                var n = ie.queue(e, t),
                    ...
                    r = function() { ie.dequeue(e, t) };
                "inprogress" === o && (o = n.shift(), i--), o && ("fx" === t && n.unshift("inprogress"), delete a.stop, o.call(e, r, a)), !i && a && a.empty.fire()
            },
            _queueHooks: function(e, t) {
                var n = t + "queueHooks";
                return ke.get(e, n) || ke.access(e, n, { empty: ie.Callbacks("once memory").add(function() { ke.remove(e, [t + "queue", n]) }) })
            }
        }), ie.fn.extend({
            queue: function(e, t) {
                var n = 2;
            ...
            dequeue: function(e) {
                return this.each(function() { ie.dequeue(this, e) })
            },
        ...
        ie.event = {
            ...
            add: function(e, t, n, i, o) {
                ...
                if (m)
                    for (n.handler && (a = n, n = a.handler, o = a.selector), n.guid || (n.guid = ie.guid++), (l = m.events) || (l = m.events = {}), (r = m.handle) || (r = m.handle = function(t) {
                        ...
                        }), t = (t || "").match(ve) || [""], c = t.length; c--;) s = Ne.exec(t[c]) || [], h = g = s[1], f = (s[2] || "").split(".").sort(), h && (p = ie.event.special[h] || {}, h = (o ? p.delegateType : p.bindType) || h, p = ie.event.special[h] || {}, u = ie.extend({ type: h, origType: g, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && ie.expr.match.needsContext.test(o), namespace: f.join(".") }, a), (d = l[h]) || (d = l[h] = [], d.delegateCount = 0, p.setup && p.setup.call(e, i, f, r) !== !1 || e.addEventListener && e.addEventListener(h, r, !1)), p.add && (p.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, u) : d.push(u), ie.event.global[h] = !0)
            },
        ...
        }, ie.removeEvent = function(e, t, n) { e.removeEventListener && e.removeEventListener(t, n, !1) }, ie.Event = function(e, t) {
        ...
        }), ee.focusinBubbles || ie.each({ focus: "focusin", blur: "focusout" }, function(e, t) {
            ...
            on: function(e, t, n, i, o) {
                ...
                }, i.guid = a.guid || (a.guid = ie.guid++)), this.each(function() { ie.event.add(this, e, i, n, t) })
            },
            ...
            off: function(e, t, n) {
                ...
                return (t === !1 || "function" == typeof t) && (n = t, t = void 0), n === !1 && (n = f), this.each(function() { ie.event.remove(this, e, n, t) })
            },
        ...
        Re.optgroup = Re.option, Re.tbody = Re.tfoot = Re.colgroup = Re.caption = Re.thead, Re.th = Re.td, ie.extend({
            ...
            replaceWith: function() {
                var e = arguments[0];
                return this.domManip(arguments, function(t) { e = this.parentNode, ie.cleanData(k(this)), e && e.replaceChild(t, this) }), e && (e.length || e.nodeType) ? this : this.remove()
            },
            detach: function(e) {
        ...
        ie.extend({
            ...
            return t ? ie.swap(e, { display: "inline-block" }, C, [e, "marginRight"]) : void 0
            ...
            toggle: function(e) {
                return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function() { Pe(this) ? ie(this).show() : ie(this).hide() })
            }
        }), ie.Tween = I, I.prototype = {
            constructor: I,
            init: function(e, t, n, i, o, a) { this.elem = e, this.prop = n, this.easing = o || "swing", this.options = t, this.start = this.now = this.cur(), this.end = i, this.unit = a || (ie.cssNumber[n] ? "" : "px") },
            cur: function() {
            ...
            _default: {
                ...
                set: function(e) { ie.fx.step[e.prop] ? ie.fx.step[e.prop](e) : e.elem.style && (null != e.elem.style[ie.cssProps[e.prop]] || ie.cssHooks[e.prop]) ? ie.style(e.elem, e.prop, e.now + e.unit) : e.elem[e.prop] = e.now }
            }
        }, I.propHooks.scrollTop = I.propHooks.scrollLeft = { set: function(e) { e.elem.nodeType && e.elem.parentNode && (e.elem[e.prop] = e.now) } }, ie.easing = {
            linear: function(e) {
                return e
            },
            swing: function(e) {
        ...
        ie.Animation = ie.extend(B, {
                ...
                prefilter: function(e, t) { t ? at.unshift(e) : at.push(e) }
            ...
            }, ie.fx.timer = function(e) { ie.timers.push(e), e() ? ie.fx.start() : ie.timers.pop() }, ie.fx.interval = 13, ie.fx.start = function() { tt || (tt = setInterval(ie.fx.tick, ie.fx.interval)) }, ie.fx.stop = function() { clearInterval(tt), tt = null }, ie.fx.speeds = { slow: 600, fast: 200, _default: 400 }, ie.fn.delay = function(e, t) {
        ...
        ie.fn.extend({
            ...
            removeProp: function(e) {
                return this.each(function() { delete this[ie.propFix[e] || e] })
            }
        }), ie.extend({
        ...
        ie.extend({
            ...
            ajax: function(e, t) {
                ...
                if (i = F(_t, p, t, k)) {
                    k.readyState = 1, c && h.trigger("ajaxSend", [k, p]), p.async && p.timeout > 0 && (s = setTimeout(function() { k.abort("timeout") }, p.timeout));
            ...
            ie[t] = function(e, n, i, o) {
                return ie.isFunction(n) && (o = o || i, i = n, n = void 0), ie.ajax({ url: e, type: t, dataType: o, data: n, success: i })
            }
            ...
            unwrap: function() {
                return this.parent().each(function() { ie.nodeName(this, "body") || ie(this).replaceWith(this.childNodes) }).end()
            }
        ...
        n.attachEvent && n.attachEvent("onunload", function() {
            ...
            return ee.cors || Lt && !e.crossDomain ? {
                send: function(n, i) {
                    ...
                    t = function(e) {
                        return function() { t && (delete Nt[r], t = a.onload = a.onerror = null, "abort" === e ? a.abort() : "error" === e ? i(a.status, a.statusText) : i(Ot[a.status] || a.status, a.statusText, "string" == typeof a.responseText ? { text: a.responseText } : void 0, a.getAllResponseHeaders())) }
        ...
        }), ie.ajaxPrefilter("script", function(e) { void 0 === e.cache && (e.cache = !1), e.crossDomain && (e.type = "GET") }), ie.ajaxTransport("script", function(e) {
            if (e.crossDomain) {
                var t, n;
        ...
        ie.ajaxSetup({
            ...
            }, e.dataTypes[0] = "json", a = n[o], n[o] = function() { r = arguments }, i.always(function() { n[o] = a, e[o] && (e.jsonpCallback = t.jsonpCallback, Ht.push(o)), r && ie.isFunction(a) && a(r[0]), r = a = void 0 }), "script") : void 0
        ...
        ie.fn.load = function(e, t, n) {
            ...
            var i, o, a, r = this,
                s = e.indexOf(" ");
            return s >= 0 && (i = ie.trim(e.slice(s)), e = e.slice(0, s)), ie.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), r.length > 0 && ie.ajax({ url: e, type: o, dataType: "html", data: t }).done(function(e) { a = arguments, r.html(i ? ie("<div>").append(ie.parseHTML(e)).find(i) : e) }).complete(n && function(e, t) { r.each(n, a || [e.responseText, t, e]) }), this
        ...
        ie.offset = {
            ...
            offset: function(e) {
                ...
                var t, n, i = this[0],
                    o = { top: 0, left: 0 },
                    a = i && i.ownerDocument;
                if (a) return t = a.documentElement, ie.contains(t, i) ? (typeof i.getBoundingClientRect !== Ee && (o = i.getBoundingClientRect()), n = W(a), { top: o.top + n.pageYOffset - t.clientTop, left: o.left + n.pageXOffset - t.clientLeft }) : o
            },
            position: function() {
                if (this[0]) {
                    var e, t, n = this[0],
                        i = { top: 0, left: 0 };
                    return "fixed" === ie.css(n, "position") ? t = n.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), ie.nodeName(e[0], "html") || (i = e.offset()), i.top += ie.css(e[0], "borderTopWidth", !0), i.left += ie.css(e[0], "borderLeftWidth", !0)), { top: t.top - i.top - ie.css(n, "marginTop", !0), left: t.left - i.left - ie.css(n, "marginLeft", !0) }
                }
            },
    ...
    (function(e) {
        e.browser || (e.browser = {}, function() {
            ...
            browserMatch = { browser: r[1] || "", version: r[2] || "0" }, browserMatch.browser && (e.browser[browserMatch.browser] = !0, e.browser.version = browserMatch.version)
        }())
    }).call(t, n(1))
}, function(e, t) {
    var n = function() {
    ...
    (function(t) {
        ...
        n(8),
            function() {
                ...
                t(document).on("click", ".dt-ccodepic", function() { o(".dt-ccodepic", "input[name=token]") })
            }(), e.exports = i
    }).call(t, n(1))
}, function(e, t, n) {
    var i = n(1);
    ...
    var o = function() {
        ...
        return {
            PopOut: function() {
                return {
                    fnCloseMask: function() { this.closeMask() },
                    poptorylen: 10,
                    poptory: [],
                    WD: [400, 484, 660],
                    ...
                    alert: function(e, t, n) {
                        ...
                        } else o.poptory = [{ head: e[0], cont: i(e[1]), n: t, ht: s, opt: n }].concat(o.poptory), o.poptory.length = o.poptorylen;
                    ...
                    blockPop: function(e, t, n, o) {
                        ...
                        var l, c, u, p = !1;
                        "fixed" === o.position ? p = !0 : (l = i(window), c = l.scrollTop(), u = l.height()), i.blockUI({ message: e, baseZ: 9e3, focusInput: o && void 0 !== o.focus ? o.focus : !0, onUnblock: function() { s.find(".mask-cont:empty").closest(".mask-body").remove(), o && i.isFunction(o.fn) && o.fn() }, css: { position: o.position, top: p ? "50%" : c, left: "50%", textAlign: "left", marginLeft: -(r[t] / 2), marginTop: p ? -(n / 2) - 20 : n >= u ? 0 : (u - n) / 2, width: r[t], height: n, border: "none", background: "none" }, fadeIn: i(".blockOverlay:visible").length ? 0 : 200 }), 1 > t && a.setOverLay()
                    },
                    setOverLay: function() {
                        if (!t) {
                            ...
                            i("div.blockOverlay").css({ width: n + 24, height: o + 24, top: "50%", left: "50%", marginTop: a - 12, marginLeft: r - 12, "border-radius": "8px", "-moz-border-radius": "8px", "-webkit-border-radius": "8px" })
                        }
                    },
                    bindClose: function() { i(document).on("click", ".mask-close", function() { o.PopOut.closeMask() }) },
                    closeMask: function() { i.unblockUI() }
                }
            }()
        }
    }();
    ...
    (function(e) {
        ! function(e) {
            ...
            e.blockUI = function(e) { t(window, e) }, e.unblockUI = function(e) { n(window, e) }, e.growlUI = function(t, n, i, o) {
                ...
                t && a.append("<h1>" + t + "</h1>"), n && a.append("<h2>" + n + "</h2>"), void 0 == i && (i = 3e3), e.blockUI({ message: a, fadeIn: 700, fadeOut: 1e3, centerY: !1, timeout: i, showOverlay: !1, onUnblock: o, css: e.blockUI.defaults.growlCSS })
            }, e.fn.block = function(n) {
                return this.unblock({ fadeOut: 0 }).each(function() { "static" == e.css(this, "position") && (this.style.position = "relative"), e.browser.msie && (this.style.zoom = 1), t(this, n) })
                ...
                n = {
                    ...
                    scrollToAnchor: function(e, n) {
                        ...
                        var i = (t(window), t("body,html")),
                            o = t("a[name=" + e + "]"),
                            a = o.offset().top - n || 0;
                        e && o.length ? i.animate({ scrollTop: a }, 200) : window.ActiveXObject && !window.XMLHttpRequest && i.animate({ scrollTop: a }, 200)
                    },
                    ...
                    setCookie: function(e, n) { t.Bom.setSubCookie("sg", e, n) },
                    setDayCookie: function(e, n) { t.Bom.setSubCookie("sgd", e, n, { expires: 1 }) },
                    setWeekCookie: function(e, n) { t.Bom.setSubCookie("sgw", e, n, { expires: 7 }) },
                    setMonthCookie: function(e, n) { t.Bom.setSubCookie("sgm", e, n, { expires: 30 }) },
                    setYearCookie: function(e, n) { t.Bom.setSubCookie("sgy", e, n, { expires: 365 }) },
                    isLink: function(e) {
                    ...
                    blinkIt: function(e, n, i, o, a) {
                        return a = a || 1e3, 0 === o ? void i() : (t.isFunction(e) && e(), void window.setTimeout(function() { t.G.blinkIt(n, e, i, --o, a) }, a))
                    },
                    bindChecks: function(e, n, i, o, a, r) {
                        function s(e) {
                            ...
                            }), c.prop("checked", !0).add(o).addClass("checked")) : (o.each(function(e, n) { t(n).prop("checked", !1) }), c.prop("checked", !1).add(o).removeClass("checked")), i = t.trim(n.join(" ")).replace(/ /gi, ","), c.attr("dvalue", i), c.filter("[type=checkbox]").val(i)
                        }
            ...
            e.Bom = function() {
                ...
                return {
                    ...
                    removeCookie: function(t, n) {
                        return "string" === e.type(t) && !t == !1 ? (n = e.extend(n || {}, { expires: new Date(0) }), this.setCookie(t, "", n)) : void 0
                    },
                    ...
                    addBookmark: function(e, t) { window.sidebar ? window.sidebar.addPanel(t ? t : document.title, e ? e : window.location.href, "") : window.external ? window.external.AddFavorite(e ? e : location.href, t ? t : document.title) : alert("加入收藏失败，请使用Ctrl+D进行添加") },
                    setHome: function(e) {
                        e = e ? e : location.href;
    ...
    ! function(a) {
        ...
        t.ajaxSetup({
            ...
            wrongmsg: function(e) {
                ...
                n && a && (a.PopOut.alert('<div class="prompt prompt-fail"><h3>' + n + "</h3></div>"), t({}).delay(4e3).queue(function() { a.PopOut.closeMask() }))
            },
            errormsg: function() { a && (a.PopOut.alert('<div class="prompt prompt-fail"><h3>网络出问题了，请稍后再试</h3></div>'), t({}).delay(2e3).queue(function() { a.PopOut.closeMask() })) },
            ...
            error: function(e, n) { t.G.gaq("/_trc/Error/ajax/status_" + n + "_" + (this.url ? this.url : "null_" + window.location.href)), t.isFunction(this.myerror) && this.myerror(e, n) }
        })
    })
}, function(e, t, n) {
    var i = n(1);
        ...
        e(function() {
            ...
            if (-1 === t.indexOf(window.location.pathname)) {
                ...
                if ("true" !== n) {
                    ...
                    setTimeout(function() { e.G.getUSERID() || SUGAR.PopOut.login() }, 2e3)
        ...
        ! function(e) {
            e.fn.hasMenu = function(t) {
                ...
                n.each(function(n, i) {
                    var o, a, r = e(i),
                        s = r.find(t);
                    r.mouseover(function() { clearTimeout(a), s.hasClass("disable") || (o = setTimeout(function() { s.length ? s.addClass("show") : r.addClass("show") }, 200)) }).mouseout(function() { clearTimeout(o), s.hasClass("disable") || (a = setTimeout(function() { s.length ? s.removeClass("show") : r.removeClass("show") }, 400)) })
                })
            }
        }(e)
    }).call(t, n(1))
                ...
                var o = {
                        ...
                        _feature: function(i, o) {
                            ...
                            if (o.seat) {
                                ...
                                var p = a.offset();
                                i.inittop = p.top, i.initleft = p.left, i.$wrap.css({ width: o.width, height: o.height })
                            } else t || 1 != o.isFixed || (u = "fixed");
                            a.css({ position: u, bottom: "auto", zIndex: o.zIndex, width: i.size[0], height: i.size[1] }), i.bias = "middle" === o.bias ? (c - i.size[1]) / 2 : o.bias, i.departure = "center" === o.departure ? (l - i.size[0]) / 2 : o.departure, (t && "bottom" == o.baseline || n && "bottom" == o.baseline) && (i.bias -= 2), a.css({ left: "right" === o.dockSide ? "auto" : i.departure, right: "left" === o.dockSide ? "auto" : i.departure }), "bottom" == o.baseline ? o.seat || t || 1 != o.isFixed || a.css({ top: "auto", bottom: i.bias }) : "top" == o.baseline && (o.seat || t || 1 != o.isFixed || a.css({ bottom: "auto", top: i.bias }))
                        },
                        ...
                        _scrollAnim: function(e, t) { 2 === t.scroll ? e.$dom.stop().css({ opacity: 0, top: o._getTop(e, t)[0] }).animate({ opacity: 1 }, t.fadeSpeed, function() { e.$bar.css("display", "block") }) : e.$dom.animate({ top: o._getTop(e, t)[0] }, t.floatSpeed, function() { e.$bar.css("display", "block") }) },
                        _eventScroll: function(t) {
                            var n = t.data.props,
                                i = t.data.c;
                            2 === i.scroll && n.$dom.not(":animated").css({ opacity: 0 }), e.isFunction(i.withScroll) && i.withScroll(), window.clearTimeout(n.scrollTimer), n.scrollTimer = window.setTimeout(function() { o._scrollAnim(n, i) }, i.scrollDelayTime)
                        },
                        _scrollSeatAnim: function(e, n) {
                            var i = e.$dom,
                                a = o._getTop(e, n);
                            e.inittop = e.$wrap.offset().top, e.$wrap.find(":first-child").length || e.$wrap.append(i), a[0] < e.inittop ? (i.removeClass("SG-posfollow"), i.css({ position: "relative", top: 0, left: 0 })) : n.seatrange && a[0] > e.inittop + n.seatrange - a[2] ? i.css({ position: "relative", top: n.seatrange - a[2] + n.seattop, left: 0 }) : (i.addClass("SG-posfollow"), t || 1 != n.isFixed ? i.appendTo(n.position).css({ position: "absolute", top: a[0], left: e.initleft }) : i.css({ position: "fixed", top: a[0] - a[1] + n.seattop, left: e.initleft }))
                        },
                        ...
                        _bindScroll: function(n, i) {
                            return !i.seat && !t && 1 == i.isFixed || 0 === i.scroll ? void n.$bar.css("display", "block") : void(i.seat ? (n.$bar.css("display", "block"), e(window).scroll({ props: n, c: i }, o._eventScrollSeat), o._scrollSeatAnim(n, i)) : (e(window).scroll({ props: n, c: i }, o._eventScroll), o._scrollAnim(n, i)))
                        },
                        _unbindScroll: function() { e(window).unbind("scroll", o._eventScroll) },
                        ...
                        min: function(t, n) {
                            ...
                            a || "bottom" !== n.baseline || (r.marginTop = t.size[1] - n.remainArea), i.animate(r, function() { e("." + o.min, i).css("display", "none"), e("." + o.max, i).css("display", "inline") })
                        },
                        max: function(t, n) {
                            var i = t.$dom,
                                o = n.btnClass,
                            ...
                            a || "bottom" !== n.baseline || (r.marginTop = 0), i.animate(r, function() { e("." + o.min, i).css("display", "inline"), e("." + o.max, i).css("display", "none") })
                        },
                        _noop: e.noop
                    },
    ...
    (function(t) {
        var n = function() {
            ...
            i.on("keydown", function(e) {
                ...
                e = setTimeout(function() { i.removeClass("show") }, 400)
            ...
            }).mouseout(function(e) { t(a[0]).trigger("mouseover") }).click(function(e) { o.click() }), window.location.pathname.match(/^\/shopping\/.*$/) ? (a.removeClass("hover"), t(a[1]).addClass("hover").trigger("mouseover")) : (a.removeClass("hover"), t(a[0]).addClass("hover").trigger("mouseover"))
        };
        e.exports = n
    }).call(t, n(1))
}, function(e, t, n) {
    (function(t) {
        ...
        var o = function() {
            function e() {
                ...
                f.on("click", function() { t(".dt-co-menu").length && t(".dt-co-menu").hide() }), f.on("click", ".dt-menu-message", function(e) { e.stopPropagation() }), i.click(function(e) {
                    e.preventDefault(), e.stopPropagation(), t(".dt-co-menu").show();
                    var i = o.eq(0)[0];
                    n(i)
                }), o.click(function() { this.switchTab = n, this.switchTab(this) })
            }
            ...
            f.on("click", ".dt-menu-inner-content-item .dt-people-avatar", function(e) {
                ...
                var n = t(this),
                    i = n.data("albumid");
                n.hasClass("abtn-no") || (n.addClass("abtn-no"), t.ajax({ url: "/napi/album/co_album_invitation/reject/", data: { album_id: i }, mysuccess: function(e, t) { n.closest("li").remove() } }).always(function() { n.removeClass("abtn-no") }))
                ...
                }).always(function() { n.removeClass("abtn-no") }))
            }), t(".dt-friend").SGfollow("a[data-follow]"), t("#dt-notification").length && (window.setTimeout(function() { r() }, 500), window.location.href.toString().match(/duitang\.com\/myhome/gi) && window.setInterval(r(), 2e4)), e()
        };
        e.exports = o
    }).call(t, n(1))
}, function(e, t, n) {
                ...
                function n(t, n) {
                    ...
                    function o() {
                        V && (G.append(e('<div class="jspVerticalBar" />').append(e('<div class="jspCap jspCapTop" />'), e('<div class="jspTrack" />').append(e('<div class="jspDrag" />').append(e('<div class="jspDragTop" />'), e('<div class="jspDragBottom" />'))), e('<div class="jspCap jspCapBottom" />'))), ne = G.find(">.jspVerticalBar"), ie = ne.find(">.jspTrack"), K = ie.find(">.jspDrag"), $.showArrows && (se = e('<a class="jspArrow jspArrowUp" />').bind("mousedown.jsp", u(0, -1)).bind("click.jsp", A), le = e('<a class="jspArrow jspArrowDown" />').bind("mousedown.jsp", u(0, 1)).bind("click.jsp", A), $.arrowScrollOnHover && (se.bind("mouseover.jsp", u(0, -1, se)), le.bind("mouseover.jsp", u(0, 1, le))), c(ie, $.verticalArrowPositions, se, le)), ae = R, G.find(">.jspVerticalBar>.jspCap:visible,>.jspVerticalBar>.jspArrow").each(function() { ae -= e(this).outerHeight() }), K.hover(function() { K.addClass("jspHover") }, function() { K.removeClass("jspHover") }).bind("mousedown.jsp", function(t) {
                            ...
                            return e("html").bind("mousemove.jsp", function(e) { g(e.pageY - n, !1) }).bind("mouseup.jsp mouseleave.jsp", f), !1
                        }), a())
                    }
                    ...
                    function M() {
                        ...
                        }).bind("touchend.jsp", function(e) { a = !1 }).bind("click.jsp-touchclick", function(e) {
                    ...
                    "border-box" === t.css("box-sizing") ? (me = 0, ve = 0) : (me = t.css("paddingTop") + " " + t.css("paddingRight") + " " + t.css("paddingBottom") + " " + t.css("paddingLeft"), ve = (parseInt(t.css("paddingLeft"), 10) || 0) + (parseInt(t.css("paddingRight"), 10) || 0)), e.extend(ye, {
                        reinitialise: function(t) { t = e.extend({}, $, t), i(t) },
                        scrollToElement: function(e, t, n) { _(e, t, n) },
                        scrollTo: function(e, t, n) { x(e, n), k(t, n) },
                        scrollToX: function(e, t) { x(e, t) },
                        scrollToY: function(e, t) { k(e, t) },
                        scrollToPercentX: function(e, t) { x(e * (U - q), t) },
                        scrollToPercentY: function(e, t) { k(e * (W - R), t) },
                        scrollBy: function(e, t, n) { ye.scrollByX(e, n), ye.scrollByY(t, n) },
                        ...
                        positionDragX: function(e, t) { v(e, t) },
                        positionDragY: function(e, t) { g(e, t) },
                        animate: function(e, t, n, i) {
                            var o = {};
                            o[t] = n, e.animate(o, { duration: $.animateDuration, easing: $.animateEase, queue: !1, step: i })
                        },
                        ...
                        scrollToBottom: function(e) { g(J, e) },
                ...
                init: function(i, a) {
                    ...
                    if ("function" != typeof i && (a = i, i = o.noop), T = i, a && o.isPlainObject(a) && (P = o.extend({}, a)), P && P.type && (D.type = P.type), !D.inited && (D.inited = !0, t = o("#sgcoll-up"), e = o.G.store(), E, e.length || (e = o('<div id="win-house" class="h0"></div>').appendTo("body")), !t.length)) {
                        ...
                        l.submit(function(e) { e.preventDefault(), o.SGColl.doFetchPic() }), o("#sgcoll-fetch-cancel").click(function(e) { e.preventDefault(), o.SGColl.resetFetch() }), c.focus(function(e) {
                            var t = this;
                            o.browser.webkit ? setTimeout(function() { t.select() }, 10) : t.select()
                ...
                doPost: function() {
                    ...
                    if (!t.hasClass("abtn-no")) {
                        ...
                        g.find(".added-tag").each(function(e, t) {
                            ...
                            myerror: function() { o.SGAlert.show("网络出问题了，请稍后再试") }
                        }).always(function() { t.removeClass("abtn-no") })
                    }
                },
            ...
            function() {
                e.SGAlert = e.SGAlert || {}, e.SGAlert.show = function(t, n, i, o) {
                    ...
                    var l = s.outerWidth(),
                        c = s.outerHeight(!0),
                        u = 200;
                    s.css({ top: -c, visibility: "visible", left: (r - l) / 2 }).animate({ top: 0, opacity: 1 }, u), n && n > 0 && s.data("timer", window.setTimeout(function() { s.animate({ top: -c, opacity: 0 }, u, function() { s.css("visibility", "hidden") }) }, n))
                }, e.SGAlert.clean = function() { e(".SGAlert-holder").remove() }
            }()
    }).call(t, n(1))
}, function(e, t, n) {
    function i(e) {
    ...
    (function(t) {
        ...
        var i = n(5),
            o = function(e) {
                ...
                s.lengthLimit();
                var u = {
                    tags: { user_tags: [], def_tags: [], used_tags: [], added_tags: [] },
                    _init: function() {
                    ...
                    _saveToCookie: function() { t.G.setMonthCookie("usedtags", this.tags.def_tags.join(";") + ";|;" + this.tags.used_tags.slice(0, 20).join(";")) },
                    ...
                    _addTagIds: function(e) { e && t(e).each(function(e, t) { n.find('a.added-tag[data-tit="' + t.name + '"]').data("tagid", t.tag_id) }) },
                    ...
                    _afterSubmit: function() { this.tags.user_tags = this._getCurTags(), this.tags.added_tags = [] }
                };
                l.on("click", function(e) { u.tags.added_tags = [], r.find(".locked").removeClass("locked") }), r.delegate("a", "click", function(e) {
                    ...
                    if (!i.hasClass("locked")) {
                        ...
                        i.hasClass("def-tags") ? r.find(".def-tags").each(function() { t(this).hasClass("locked") || t(this).addClass("locked") }) : i.addClass("locked"), u._add(o), s.focus()
                    }
                ...
                }), n.click(function(e) { s.focus() }), n.delegate("a", "click", function(e) {
        ...
        ! function(e) {
            e.fn.getFormAction = function() {
                ...
                return this.filter("textarea,input[type=text]").each(function() {
                    ...
                    e(this).change(function(e) { i.call(this, e) }).keyup(function(e) { i.call(this, e) }), i.apply(this)
                }), this
                    ...
                    var t = e(this),
                        ...
                        o = function(o) {
                            ...
                            if (a && 8 !== a && 13 !== a && !(a > 36 && 41 > a)) {
                                ...
                                " " != r[r.length - 1] && s && s.lenB() > i && (s = s.cut(i, ""), r = l + s), t.val(r.replace(n.invalid, "")), vl = t.val().length, e.G.setCursorPosition(t[0], { start: vl, end: vl })
                            }
                        };
                    e(this).change(function(e) { o.call(this, e) }).keyup(function(e) { o.call(this, e) }), o.apply(this)
                }), this
            ...
            n.special.safeSubmit = {
                ...
                return "function" != typeof i && (i = n, n = t, t = null), i = i || function() { alert("请输入内容") }, arguments.length > 0 ? this.unbind("safeSubmit").bind("safeSubmit", t, function(t) {
                    var o = this,
                        ...
                        s = e("[type=submit]", a),
                        l = !0;
                    r.each(function(t, n) { "" === e.trim(e(n).val()) && l && (l = !1) }), s.each(function(t, n) { e(n).prop("disabled") && l && (l = !1) }), l ? n.call(this, arguments) : i.call(this, arguments)
    ...
    (function(e) {
        ...
        ! function(e) {
            ...
            }, e.fn.uploadpic.defaults = { onupload: e.noop, sel_holder: "", sel_form: "", sel_input: "input[type=file]", sel_normal: "", sel_error: "", sel_uploading: "", sel_uploaded: "" }, e.fn.uploadpic.upPicCallBack = function(t) {
                if (e.isPlainObject(t)) {
    ...
    i(function() {
        function e() {
            ...
            e.length || (e = i('	        <div id="popcreatealbum" class="popcreatealbum"> 	        <form id="form-popcreatealbum" method="post" action="/napi/album/create/"> 	        <table cellspacing="0" cellpadding="0"> 	        <tr> 	        <td width="60" align="right">专辑名</td> 	        <td><input class="ipt" type="text" name="name" value="" maxlength="40"/></td> 	        <td rowspan="4"> 	        <h6>常用标签</h6> 	        <div class="usetag da" id="popal-mbaddtagsel"> 	        </div> 	        </td> 	        </tr> 	        <tr> 	        <td align="right">描述</td> 	        <td><textarea class="txa" name="desc" maxlength="600" data-optional="1"></textarea></td> 	        </tr> 	        <tr> 	        <td align="right">标签</td> 	        <td> 	        <div class="pr"> 	        <div class="divipt clr"><input id="popal-mbaddtagipt" class="l ipt mr8" autocomplete="off" type="text" name="tags" value=""  maxlength="100" data-optional="1"/></div> 	        <label for="popal-mbaddtagipt" id="popal-mbaddtag-lb">多个标签用空格隔开</label> 	        </div> 	        </td> 	        </tr> 	        <tr> 	        <td>&nbsp;</td> 	        <td><a class="abtn l" href="javascript:;" target="_target"><button type="submit"><u>创建</u></button></a></td> 	        </tr> 	        </table> 	        </form> 	        </div>').appendTo(s), i.fn.comtags && i("#popal-mbaddtagsel").html(function() {
                ...
                if (i.G.getUSERID()) {
                    ...
                    n.hasClass("abtn-no") || (n.addClass("abtn-no"), i.ajax({ url: t.getFormAction(), data: t.paramForm(o(2)), mysuccess: function(e, t) { location.href = "/album/?id=" + e.data.album.id }, myfailure: function(e, t) { e.data && e.data.robot_check ? a.verif({ w: 1 }) : this.wrongmsg(e) }, myerror: function() { this.errormsg() } }).always(function() { n.removeClass("abtn-no") }))
                }
        ...
        function t(e) {
            ...
            t.length ? (t.find("form").attr("action", o), t.find(".albumbock-sw").text(n)) : (t = i('<div id="popalbumblock" class="prompt"><form id="form-albumblock" method="post" action="' + o + '"><p class="albumconfirm" >将<span class="albumbock-sw">' + n + '</span>该专辑以及其中的图片。</p><div class="album-pop-action clr"><a class="abtn abtn-w4 l" href="javascript:;" target="_self"><button type="submit"><u>确定<span class="albumbock-sw">' + n + "</span></u></button></a></div></form></div>").appendTo(s), i("#form-albumblock").delegate(".cancel", "click", function(e) { a.PopOut.closeMask(0) }), i("#form-albumblock").safeSubmit(function(e) {
                if (i.G.getUSERID()) {
                    ...
                    }).always(function() { a.PopOut.closeMask(), n.removeClass("abtn-no") }))
                }
                ...
                if (i.G.getUSERID()) {
                    ...
                    n.hasClass("abtn-no") || (n.addClass("abtn-no"), i.ajax({
                        ...
                        mysuccess: function(e) {
                            ...
                            }) : (i({}).delay(1e3).queue(function() { a.PopOut.closeMask(0) }), i(l).closest("div.woo").remove())
                        }
                    }).always(function() { n.removeClass("abtn-no") }))
                }
        ...
        }), i("#woo-holder").delegate("a.delthisalbum", "click", function(e) { e.preventDefault(), l = this, n() }), i("#albumdelbtn").click(function(e) { e.preventDefault(), l = this, n() })
    })
    ...
    (function($, module) {
        this.JSON || (this.JSON = {}),
            ...
            function(e) {
                ...
                if (a.disabled = !1, a.set = function(e, t) {}, a.get = function(e) {}, a.remove = function(e) {}, a.clear = function() {}, a.transact = function(e, t, n) {
                ...
                }, a.remove = function(e) { o.removeItem(e) }, a.clear = function() { o.clear() }, a.getAll = function() {
                    var e = {};
                    return a.forEach(function(t, n) { e[t] = n }), e
                    ...
                    a.set = n(function(e, t, n) {
                    ...
                    }), a.remove = n(function(e, t) { t = i(t), e.removeAttribute(t), e.save(s) }), a.clear = n(function(e) {
                        ...
                        var t = {};
                        return a.forEach(function(e, n) { t[e] = n }), t
        ...
        return function(e) {
            ...
            o.prototype = {
                    ...
                    setupHelper: function(e, t, n) {
                        ...
                        return { params: i, paramsInit: o, name: a, callParams: [r].concat(i) }
                    },
            ...
            i.prototype = {
                ...
                DecoratorBlock: a,
                PartialStatement: r,
                PartialBlockStatement: function(e) { r.call(this, e), this.acceptKey(e, "program") },
            ...
            function l(e, t, n) {
                ...
                for (var i = e ? "@" : "", o = [], a = 0, r = "", s = 0, l = t.length; l > s; s++) {
                    ...
                    if (i += (t[s].separator || "") + c, u || ".." !== c && "." !== c && "this" !== c) o.push(c);
                        ...
                        if (o.length > 0) throw new m["default"]("Invalid path: " + i, { loc: n });
                        ".." === c && (a++, r += "../")
                    }
                }
            ...
            var a = n(13),
                r = void 0;
            try {} catch (s) {}
            r || (r = function(e, t, n, i) { this.src = "", i && this.add(i) }, r.prototype = {
                add: function(e) { a.isArray(e) && (e = e.join("")), this.src += e },
                prepend: function(e) { a.isArray(e) && (e = e.join("")), this.src = e + this.src },
            ...
            t["default"] = function(e) {
                e.registerHelper("with", function(e, t) {
                    ...
                    var o = t.data;
                    return t.data && t.ids && (o = i.createFrame(t.data), o.contextPath = i.appendContextPath(t.data.contextPath, t.ids[0])), n(e, { data: o, blockParams: i.blockParams([e], [o && o.contextPath]) })
                })
            }, e.exports = t["default"]
        }, function(e, t, n) {
            "use strict";
